...
<body class="{{request()->routeIs('page.project_detail') ? 'is-detail' : '' }}">
<header class="site-header {{ request()->routeIs('page.home') ? 'is-home' : '' }}">
  <div>
    <a href="javascript:;" class="btn-menu-show js-menu-btn" title="Menü anzeigen"></a>
    @include('web.layout.partials.menu')
    <a href="/" title="Home | MMT AG" class="logo" title="Home">
      @include('web.layout.partials.logo')
    </a>
  </div>
  <div>
    @yield('page-header')
